  ...
  return (
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        />
        <g fill="#8ec480">
          <path d="m37.31 7.81c.88-.18 1.31.4 1.28.84s-1.22 1.06-1.69.72-.81-1.31.41-1.56z"></path>
          <path d="m37 13.59c.1-.13.63-.72 2.69-.31s3 1.09 3.56 2.46a4 4 0 0 1 .07 2.63 18.49 18.49 0 0 0 -3.16-2.84 15.27 15.27 0 0 0 -3.16-1.94z"></path>
          <path d="m48.56 13.59c.74-.33 1.06.81.84 1.56a1.09 1.09 0 0 1 -1.59.66c-.5-.35-.6-1.63.75-2.22z"></path>
        </g>
        <path 
